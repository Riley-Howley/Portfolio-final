...
namespace Portfolio.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public AboutsController(PortfolioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AboutId,Desciption")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AboutId,Desciption")] About about)
        {
            if (id != about.AboutId)
            {
                return NotFound();
